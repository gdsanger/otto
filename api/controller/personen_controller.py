...
from mongo import personen_collection, db
...
@router.get("/personen/{person_id}", dependencies=[Depends(verify_api_key)], tags=["Personen"])
async def get_person(person_id: str):
    ...
    tasks = [serialize_mongo(t) async for t in tasks_cursor]
